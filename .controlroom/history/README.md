...
- [운영서버 통합](../docs/production-server-consolidation-20260916.md): Exdigm을 제외한 DB·Coconut·RNDLOG·ZiiN·CEO Loan을 새 서버 `chaconne@49.247.192.127`에 준비합니다. 기존 DB 증설안은 폐기했습니다. 현재 운영 주소와 DNS는 그대로이며, 새 서버의 검증 완료와 운영 정본 전환을 구분합니다.
