...
- main의 중앙 Hermes 샘은 10분마다 Exdigm 운영 오류 DB를 직접 조회하고 새 오류를 조사·보고한다. 별도 systemd/Codex 자동수정 작업자는 두지 않는다. 정기 실행은 수정·배포하지 않으며, 주인님의 명시적 지시가 있을 때 샘이 Exdigm 공식 원격 경로에서 수정·검증하고 별도 배포 지시에 따라 배포한다.
