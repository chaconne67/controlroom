...
상태: 운영 DB·자료·쓰기 책임 인계 완료(16절) · 2026-09-18 DNS 12/14 확인, synco 기본/www 미변경(17절)
...
> 최신 상태: 실제 운영 정본·정상 예약 책임 인계와 최종 백업 독립 복원은 16절, 주인님의 가비아 변경 뒤 2026-09-18 00:14 KST DNS·HTTPS 실제 확인은 17절을 먼저 읽는다. 공개 DNS 14개 이름 중 12개가 새 main이며 synco.kr/www 두 이름의 원본 A는 아직 옛 IP다. 본문의 이전 승인·준비·DNS 상태는 각 확인 시점의 이력으로 보존한다.
