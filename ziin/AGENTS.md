...
- 조정실 진입 폴더는 `C:\Users\chaconne\controlroom\ziin`, main 코드 저장소는 `/home/chaconne/projects/ziin`입니다. main의 서버 조정실 진입 폴더는 `/home/chaconne/controlroom/ziin`입니다. 조정실은 지침·스킬·기획의 진입점이고 서버 폴더는 실제 `.git`과 코드를 가진 독립 저장소입니다.
