...
- [진행 중: 새 운영서버 통합](../../.controlroom/docs/production-server-consolidation-20260916.md) — 대상 `chaconne@49.247.192.127`. 현재 운영은 `49.247.38.186`입니다. 새 서버에서는 전체 Swarm 스택을 제거하는 기존 배포 스크립트를 실행하지 않으며, 운영 배치의 중복 실행을 막은 상태로 준비합니다.
