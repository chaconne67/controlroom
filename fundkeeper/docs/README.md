...
- [투자성향 설문 감점 배점 적용 완료](<plans/2026-09-21-investor-questionnaire-negative-scoring.md>) — 기존 64점 환산·성향 구간·상한을 유지한 감점 배점을 운영에 반영했습니다. 3차 두 전략 별첨 v3 PPTX/PDF에 배점기준·수치 근거·계산 예시를 넣었으며, 운영 검증·Drive 링크·복구 정보를 기록했습니다.
