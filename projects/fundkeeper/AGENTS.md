...
- 작업 위치: `C:\Users\chaconne\projects\fundkeeper`. 애플리케이션 코드·Git·검증·배포는 아래 원격 서버의 기존 경로를 사용합니다.
...
- 기획·리서치·작업 계획은 조정실의 `docs/README.md`에서 찾습니다. 이 폴더는 `../_control-docs/fundkeeper/docs`의 같은 원본으로 연결되며, 문서 Git 이력은 `_control-docs`에서 관리합니다.
