...
코드·실행 위치: `chaconne@49.247.38.186:/home/chaconne/fundkeeper`.
...
- [2026-09-17 테스트베드 알고리즘 심사 발표 자료](<plans/2026-09-17-testbed-algorithm-review-pt-plan.md>) — 국내ETF·퇴직연금 레시피(1336~1339, 1342, 1343) 심사 PT. HTML은 [presentations/2026-09-testbed-algorithm-review](<presentations/2026-09-testbed-algorithm-review/index.html>)(3차 수정본 26장), PDF는 Drive `MOA/테스트베드3차/심사발표자료`에 있으며 `_v3` 파일이 최신입니다.
